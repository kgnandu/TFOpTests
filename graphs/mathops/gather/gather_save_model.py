...
my_feed_dict = {}
in0 = tf.placeholder("float64", [2, 4, 3, 2], name="input_1")
in1 = tf.placeholder("float64", [3, 2], name="input_2")
k0 = tf.Variable(tf.random_normal([3, 2], dtype=tf.float64), name="in0", dtype=tf.float64)
