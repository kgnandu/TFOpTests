...
from graphs.mathops.another_g_00 import get_input, save_dir
from helper import load_save_utils

tf.set_random_seed(13)

my_feed_dict = {}
in0 = tf.placeholder("float64", [4, 4, 16, 16], name="input_0")
k0 = tf.Variable(tf.random_normal([8, 8], dtype=tf.float64), name="in0", dtype=tf.float64)
