...
class PrimitiveGRU(TestGraph):
    def __init__(self, feature_size=5, time_steps=9, *args, **kwargs):
        ...
        super(PrimitiveGRU, self).__init__(*args, **kwargs)
...
def test_primitive_gru():
    feature_size = 2
    num_hidden = 3
    primitive_lstm = PrimitiveGRU(seed=713, feature_size=feature_size, time_steps=7)
    weights = {
    ...
    tfp = TensorFlowPersistor(save_dir="primitive_gru")
